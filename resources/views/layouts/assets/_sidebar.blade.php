            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview {{ Request::routeIs('salereport.index', 'report.bills', 'report.withdrawals', 'report.adjustments') ? 'menu-open' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item"><a href="{{ route('report.adjustments') }}" class="nav-link {{ Request::routeIs('report.adjustments') ? 'active' : '' }}"><i class="fas fa-sliders-h nav-icon "></i> <p>รายงานกาปรับยอดวัตถุดิบสินค้า</p></a></li>
                    </ul>
                </li>
